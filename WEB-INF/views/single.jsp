		...
		<div class="cont span_2_of_3">
				     ...
				     <ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="${productForSinglPag.photoUrl}" />
									<img class="etalage_source_image" src="${productForSinglPag.photoUrl}" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="${productForSinglPag.photoUrl}" />
			...
			<div class="cont1 span_2_of_a1">
				...
				<ul class="add-to-links">
    			   <li><img src="${productForSinglPag.photoUrl}" alt=""/><a href="#">Add to wishlist</a></li>
    			</ul>
    			<p class="m_desc"> ${productForSinglPag.description}   ${productForSinglPag.shortDescription}</p>
         ...
         <ul id="flexiselDemo3">
			<li><img src="${productForSinglPag.photoUrl}" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
			<li><img src="${productForSinglPag.photoUrl}" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
			<li><img src="${productForSinglPag.photoUrl}" /><div class="grid-flex"><a href="#">Zumba</a><p>Rs 850</p></div></li>
			<li><img src="${productForSinglPag.photoUrl}" /><div class="grid-flex"><a href="#">Bloch</a><p>Rs 850</p></div></li>
			<li><img src="${productForSinglPag.photoUrl}" /><div class="grid-flex"><a href="#">Capzio</a><p>Rs 850</p></div></li>
		 </ul>
