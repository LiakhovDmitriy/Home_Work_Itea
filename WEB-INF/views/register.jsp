		...
		<div class="wrap">
				...
				<form action="/registration" method="post">
						...
						<div class="col_1_of_2 span_1_of_2">
								...
								<div><input type="text" value="Email" name="login" onfocus="this.value = '';"
														onblur="if (this.value == '') {this.value = 'Email';}"></div>
								<div><input type="text" value="Password" name="password" onfocus="this.value = '';"
														onblur="if (this.value == '') {this.value = 'Password';}"></div>
								<div>
										<select id="gender" name="gender" class="frm-field required">
						...
						<div class="col_1_of_2 span_1_of_2">
								<div><input type="text" value="Address" name="address" onfocus="this.value = '';"
														onblur="if (this.value == '') {this.value = 'Address';}">
								</div>

								<div><select id="country" name="country" onchange="change_country(this.value)"
								...
								<div>
										<input type="text" value="City" name="city" onfocus="this.value = '';"
